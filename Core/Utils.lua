--[[
    ...
    General utility functions for string manipulation, validation, and helpers
    
    Note: Name/realm utilities have been moved to NameUtils.lua
]]
...
-- =============================================================================
-- Player Name Utilities (Delegated to NameUtils)
-- =============================================================================
...
function Utils:IsValidPlayerName(name)
    -- Delegate to NameUtils if available
    if Addon.NameUtils then
        return Addon.NameUtils:IsValidName(name)
    end
...
function Utils:ExtractCharacterName(fullName)
    -- Delegate to NameUtils if available
    if Addon.NameUtils then
        return Addon.NameUtils:ExtractCharacterName(fullName)
    end
...
-- @return string|nil - Canonical name or nil if invalid
function Utils:NormalizePlayerName(name)
    -- Delegate to NameUtils if available
    if Addon.NameUtils then
        return Addon.NameUtils:ToCanonical(name)
    end
